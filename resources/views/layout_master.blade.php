                ...
                console.log(data);
                  ...
                  $( data ).each(function( index ) {
                    var value=$(".mybtn").attr("value");
                        console.log(value);
                        $string=` <button type="submit" style="width:389px; padding-left:2px;padding-right:5px;  border:none; height:210px;" class="mybtn" value="${data[index].id}"><div class="data col-sm-3">
                            <div class="card bg-info"  style="width:380px";>
                              <div class="card-body">
       ...
       $.ajax({
           ...
           success:function(response){
               console.log(response)
                ...
                console.log( $('#cartSubTotal').text(response.cartTotal));
